...
describe('EVENTOS', () => {
	describe('crearEventoP', () => {
		...
		it('CP4. Nombre es null', done => {
			...
			.catch( fail => {
				fail.should.be.a('object');
				assert.equal(fail.tipo, 'Validation error', 'Tipo de error incorrecto');
				assert.equal(fail.mensaje, 'Evento.nombre cannot be null', 'Mensaje obtenido incorrecto');
				done();
			});
		});
		...
		it('CP7. Fecha de inicio null', done => {
			...
			.catch( fail => {
				fail.should.be.a('object');
				assert.equal(fail.tipo, 'Validation error', 'Tipo de error incorrecto');
				assert.equal(fail.mensaje, 'Evento.fechaInicio cannot be null', 'Mensaje obtenido incorrecto');
				done();
			});
		});
		...
		it('CP13. Estado null', done => {
			...
			.catch( fail => {
				fail.should.be.a('object');
				assert.equal(fail.tipo, 'Validation error', 'Tipo de error incorrecto');
				assert.equal(fail.mensaje, 'Evento.estado cannot be null', 'Mensaje obtenido incorrecto');
				done();
			});
		});
		...
		it('CP16. Descripción null', done => {
			...
			.catch( fail => {
				fail.should.be.a('object');
				assert.equal(fail.tipo, 'Validation error', 'Tipo de error incorrecto');
				assert.equal(fail.mensaje, 'Evento.descripcion cannot be null', 'Mensaje obtenido incorrecto');
				done();
			});
		});
		...
		it('CP19. Lugar null', done => {
			...
			.catch( fail => {
				fail.should.be.a('object');
				assert.equal(fail.tipo, 'Validation error', 'Tipo de error incorrecto');
				assert.equal(fail.mensaje, 'Evento.lugar cannot be null', 'Mensaje obtenido incorrecto');
				done();
			});
		});
	...
	describe('cambiarEstadoP', () => {
		...
		it('CP4. Estado no enviado', done => {
			...
			.catch( fail => {
				assert.equal(fail.tipo, 'Validation error', 'Tipo de error incorrecto');
				assert.equal(fail.mensaje, 'Evento.estado cannot be null', 'Mensaje de error incorrecto');
				done();
			});
		});
