...
module.exports = function(sequelize, DataTypes) {
  ...
  Persona.compararContrasenna = (candidatePassword, hash, done, user) => {
  ...
  Persona.buscarPersonaPorEmailP = (email) => {
    return new Promise( (resolve, reject) => {
  ...
  Persona.deserializarUsuario = (idPersona) => {
  ...
  ///////////////////////////////////////
  Persona.crearPersonaT = (persona, transaction) => {
    return new Promise( (resolve, reject) => {
  ...
  Persona.editarPersonaT = (idPersona, persona, transaction) => {
    return new Promise( (resolve, reject) => {
  ...
  */
  Persona.ingresarContrasenna = (idPersona, contrasenna, transaction) => {
    return new Promise( (resolve, reject) => {
      if( !idPersona )     { return reject( errors.SEQUELIZE_FK_ERROR('No ingresó el id') ); }
      if( idPersona < 0 )  { return reject( errors.SEQUELIZE_FK_ERROR('Id inválido') ); }
      return Persona.update({
  ...
  Persona.cambiarContrasenna = (email, contrasenna) => {
    return new Promise((resolve, reject) => {
      if( !email || email === '' ) { return reject( { mensaje : 'No ingresó el email'} ); }
      return Persona.update({
        contrasenna : contrasenna
  ...
  Persona.eliminarPersonaT = (idPersona, t) => {
    return new Promise( (resolve, reject) => {
      if( !idPersona )     { return reject( errors.SEQUELIZE_FK_ERROR('No ingresó el id de la persona') ); }
